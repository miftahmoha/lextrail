import { Optional, LTNetwork, LTId, LTState, LTUpdate } from './types';
...
type LTCall = (network: LTNetwork, state: LTState, updates: LTUpdate, previews: LTId[]) => void
...
export const DOM: DOM = {
    ...
    display: {
        ...
        sidebarItems: getRequiredElement<HTMLElement>('sidebar-items'),
...
export function addEventListeners(DOM: DOM, network: LTNetwork,
    ...
    DOM.buttons.btnPrev.addEventListener('click', () => {
        ...
        updateGraphs(network, state, previous, []);
