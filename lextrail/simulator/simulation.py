...
class Simulate:
    guide: CFGGuide  # Add support for Guide.
    state: dict[str, Any]
    ...
    def run(self, port=8000):
        ...
        simulation = threading.Thread(target=self.get_next_state, daemon=True)
        simulation.start()
    ...
    def get_next_state(self):
        ...
        while True:
            ...
            self.state["response"] = mock_llm.fragmented_response
    ...
    def do_GET(self):
        if self.path == "/":
            ...
            response_data = {
                ...
                "_fragmented_llm_response": self.simulate.state["response"],
